//+------------------------------------------------------------------+
//|                                AI_EA_YOU_DYNAMIC_LOTS_SPREAD.mq5 |
//|  XAUUSD M1 Dynamic Lots + Spread/Commission Cost-Aware Entries    |
//+------------------------------------------------------------------+
...
input int              InpEstimatedSlippagePointsRoundTrip = 20;
input int              InpMinNetTPAfterCostPoints = 120;
input double           InpMinTPtoCostRatio    = 1.8;
input bool             InpOnePositionOnly     = true;
input bool             InpCloseOnReverse      = true;
input bool             InpForceMinLot         = true;
input bool             InpForceMinLotAlways   = true;
input bool             InpDebug               = true;
input ulong            InpMagic               = 26030711;
